...
def PCA_KMeans():
    ...
    tmp_fname1 = os.path.join('uploads', uuid4().__str__()+'.jpg')
    tmp_fname2 = os.path.join('uploads', uuid4().__str__()+'.jpg')
    ...
    img_stream = return_img_stream("./Results/changemap.jpg")
    img_stream2= return_img_stream("./Results/cleanchangemap.jpg")
